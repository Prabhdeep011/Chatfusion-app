...
def generate_pdf():
    ...
    margin = 10  # Smaller margin for content
    ...
    for idx, chat in enumerate(st.session_state['history']):
        ...
        # Add watermark at the top-right corner of each page, close to the border
        c.setFont("Helvetica", 10)  # Smaller font for the watermark
        c.setFillColorRGB(0.8, 0.8, 0.8)  # Light grey color for watermark
        # Adjusted the y position to ensure it's right near the top edge
        c.drawRightString(width - margin, height - 5, "Generated by ChatFusion")
