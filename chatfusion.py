...
def generate_pdf():
    ...
    margin = 50  # Increased margin for better spacing around content
    ...
    for idx, chat in enumerate(st.session_state['history']):
        ...
        wrapped_prompt = wrap(prompt_text, width=80)  # Adjust width for better wrapping
        ...
        wrapped_response = wrap(response_text, width=80)  # Adjust width for better wrapping
