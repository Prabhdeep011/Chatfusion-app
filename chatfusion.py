...
def generate_pdf():
    ...
    margin = 10  # Set a smaller margin for the watermark to be closer to the border
    ...
    for idx, chat in enumerate(st.session_state['history']):
        ...
        # Add watermark near the top-right corner of each page, close to the border
        c.setFont("Helvetica", 10)  # Smaller font for the watermark
        c.setFillColorRGB(0.8, 0.8, 0.8)  # Light grey color for watermark
        c.drawRightString(width - margin, height - margin + 2, "Generated by ChatFusion")
