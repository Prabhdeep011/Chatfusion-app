...
def generate_pdf():
    ...
    # Set minimal margins to use maximum page area
    margin = 30  
    ...
    for idx, chat in enumerate(st.session_state['history']):
        ...
        wrapped_prompt = wrap(prompt_text, width=95)  # Adjusted for more content per line
        ...
        if chat.get('image'):
            ...
            image_width, image_height = 200, 200  # Larger size for clearer images
    ...
    # Add watermark at the top-right corner, without disturbing the text
    c.setFont("Helvetica", 10)
    c.setFillColorRGB(0.7, 0.7, 0.7)  # Light grey color for watermark
    c.drawRightString(right_margin - 10, height - 20, "Generated by ChatFusion")
