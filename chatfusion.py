...
def generate_pdf():
    ...
    for idx, chat in enumerate(st.session_state['history']):
        ...
        c.drawString(width - margin - 60, height - margin, "Generated by ChatFusion")  # Position at top-right corner
        ...
        if chat.get('image'):
            ...
            if y - image_height < margin:
                ...
                c.drawString(width - margin - 60, height - margin, "Generated by ChatFusion")
